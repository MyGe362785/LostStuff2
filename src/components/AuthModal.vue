  ...
  <div class="fixed inset-0 z-50 flex items-center justify-center p-4">
    ...
    >
      ...
      <button
        ...
        class="mt-5 flex min-h-12 w-full items-center justify-center gap-2.5 rounded-xl border border-brand-sand bg-white px-4 text-sm font-bold text-brand-espresso transition-colors hover:bg-brand-cream disabled:cursor-not-allowed disabled:bg-brand-cream/60 disabled:text-brand-latte disabled:opacity-70"
      ...
      <div class="mt-3 flex items-start gap-3 rounded-xl border border-brand-sand bg-white px-4 py-3.5">
        <input
          id="privacy-consent"
